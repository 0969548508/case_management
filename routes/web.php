...
Route::group(['middleware' => 'auth'], function () {
	...
	//create tenant
	Route::get('/create-tenant', 'TenantController@showCreateTenant')->name('showCreateTenant');
	Route::post('/create-tenant', 'TenantController@createTenant')->name('createTenant');
	...
	Route::post('/rate/update', 'RatesController@updateRate')->name('updateRate');
